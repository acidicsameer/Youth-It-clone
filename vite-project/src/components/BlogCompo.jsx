...
const BlogCompo = () => {
  const BlogCards = [
    ...
    },
    {
      ...
      date: "5/11/2025",
      des: "The world has already seen waves of technological revolutions, from the dot-com boom of the 1990s to the rise of artificial intelligence and cloud computing in recent years. But what if we experience a massive IT boom—one that accelerates digital transformation across every industry at an unprecedented rate? Let’s explore both the exciting possibilities and the potential risks.",
      readme: "Read More",
    },
    {
      id: 3,
            ...
            <div key={curr.id}>
              <div className="flex flex-col lg:flex-row gap-5 lg:ml-24 p-10 shadow-2xl min-h-[304px] lg:w-[65%] w-full rounded-2xl">
                <div>
                  <img
                    src={curr.img}
                    className="lg:w-[500px] w-[250px] h-[250px] m-auto rounded-2xl"
                    alt={curr.title}
                  />
                </div>
                <div className="lg:w-[424px] w-full flex flex-col gap-3">
                  ...
                  <div className="bg-blue-900 text-white font-bold rounded-2xl h-[35px] m-1 p-1.5 w-[100px]">
                    {curr.readme}
                  </div>
                </div>
              </div>
            ...
            <div key={curr.id} className="flex flex-col lg:flex-row bg-[#F6F9FE]">
              <div className="lg:w-[431px] w-full min-h-[150px] p-6 shadow-2xl rounded-3xl">
                <div className="flex gap-2 justify-center items-center">
                  ...
                  <div className="text-blue-900 font-bold w-full">
                    <Link>{curr.title}</Link>
                  </div>
                </div>
              </div>
            </div>
